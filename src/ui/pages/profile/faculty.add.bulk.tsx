...
import instructions from "./../../../assets/instructions_add_user.png";
import FacultyAddService from "../../../services/auth/faculty";

const AddFacultyBulk: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (file) {
      ...
      try {
        const res = await FacultyAddService.add_bluk(
          auth.data?.token,
          formData
        );
    ...
    <>
      <div className="container w-100 d-flex justify-content-start align-items-start flex-column py-5">
        <div className="container card shadow-lg rounded-2 p-3 col-sm-12">
          <div className="h1 text-center mb-4">Add Faculty(With .CSV File)</div>
          <div className="text-center col-sm-12 form-control w-100 shadow-sm border-1 py-3">
            <div
            ...
            >
              ...
              <ul>
                <li>
                  File must be a <strong className="text-danger">.csv</strong>{" "}
                  File.{" "}
                </li>
                <li>
                  Default password will be-{" "}
                  <strong className="text-danger">1234</strong>
                </li>
                <li>
                  User can upload{" "}
                  <strong className="text-danger">Profile Image</strong> Later.
                </li>
                <li>
            ...
            >
              <div className="input-group input-group-lg ">
                ...
                <button
                  className={`btn btn-${
                    csvData.length ? "danger" : "secondary"
                  }`}
                  onClick={() => {
          ...
          {csvData.length > 0 && (
            <div className="my-3">
              ...
              <div
                ...
                style={{ textAlign: "left" }}
              >
                It will automatically skip users who already exist.
              </div>
            </div>
          )}
          ...
          <button
            ...
            className="btn btn-dark p-3 w-100 mt-3"
          >
            {loading ? (
